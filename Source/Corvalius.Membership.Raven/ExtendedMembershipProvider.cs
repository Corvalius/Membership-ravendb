...
namespace Corvalius.Membership.Raven
{
    public abstract class ExtendedMembershipProvider : MembershipProvider
    {
        ...
        public abstract bool HasLocalAccount(int userId);

        public abstract string GenerateAccessToken(string username, TimeSpan expiration);

        public abstract bool VerifyAccessToken(string username, string token);
