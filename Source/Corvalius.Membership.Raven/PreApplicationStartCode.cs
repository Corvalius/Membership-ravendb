...
namespace Corvalius.Membership.Raven
{
    ...
    public static class PreApplicationStartCode
    {
        ...
        public static void Start()
        {
            ...
            Initializer.PreAppStartInit();

            // Initialize Forms Authentication default configuration
            SetUpFormsAuthentication();

            // Auto import the Corvalius.Membership.Raven namespace to all apps that are executing.
            WebPageRazorHost.AddGlobalImport("Corvalius.Membership.Raven");
