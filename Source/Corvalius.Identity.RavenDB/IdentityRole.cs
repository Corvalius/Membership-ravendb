...
namespace Corvalius.Identity.RavenDB
{
    ...
    public class IdentityRole<TKey> where TKey : IEquatable<TKey>
    {
        ...
        /// </summary>
        public virtual ICollection<IdentityRoleClaim> Claims { get; internal set; } = new List<IdentityRoleClaim>();
        ...
        public static string CreateId ( string normalizedName )
        {
            return $"roles/{normalizedName}";
        }
    }
}
