...
namespace Corvalius.Identity.RavenDB
{
    ...
    {
        public UserStore(IDocumentStore context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class UserStore<TUser> : UserStore<TUser, IdentityRole, IDocumentStore>
    ...
    /// <typeparam name="TDocumentStore">The type of the document store used to access the store.</typeparam>
    public class UserStore<TUser, TRole, TDocumentStore> : UserStore<TUser, TRole, TDocumentStore, string>
        where TUser : IdentityUser<string>, new()
        where TRole : IdentityRole<string>, new()
        where TDocumentStore : class, IDocumentStore
    {
        public UserStore(TDocumentStore context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class UserStore<TUser, TRole, TDocumentStore, TKey> :
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </summary>
        /// <param name="context">The document store used to access the store.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/> used to describe store errors.</param>
        public UserStore(TDocumentStore context, IdentityErrorDescriber describer = null)
        {
            if (context == null)
